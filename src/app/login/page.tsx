...
function LoginForm() {
  ...
  return <main className="flex min-h-svh items-center justify-center bg-muted/30 p-4">
    <Card className="w-full max-w-md shadow-lg">
      <CardHeader className="text-center"><div className="mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-xl bg-primary text-primary-foreground"><TrendingUp className="h-7 w-7" /></div><CardTitle className="text-2xl">Sign in to Target</CardTitle><CardDescription>Enter the credentials provided by your administrator.</CardDescription></CardHeader>
